<?php
/*
 * $Id: DataResultMysqli.class.php,v 1.4 2005/03/25 03:07:16 au5lander Exp $
 * 
 ...
 * 		DataResult
 */
class DataResultMysqli extends DataResult {
	...
	const DATA_RESULT_FORMAT_NUM = MYSQLI_NUM;
	const DATA_RESULT_FORMAT_ASSOC = MYSQLI_ASSOC;
	const DATA_RESULT_FORMAT_BOTH = MYSQLI_BOTH;
	...
	protected function getRow() {
		if($row = mysqli_fetch_array($this->result, $this->format)) {
